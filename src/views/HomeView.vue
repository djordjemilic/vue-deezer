  ...
  <div class="max-w-[1500px] mx-auto">
    <div class="px-8 mt-8 min-w-[800px] w-full">
      ...
      <div class="flex justify-between w-full gap-8">
        ...
        <div class="xl:w-1/3 w-1/2">
          ...
          <MixesInspiredBy class="pb-1.5" text="Candy Truck / You Expected" by="Bring Me the Horizon" to="/artist"
        ...
        <div class="xl:block hidden xl:w-1/3">
          ...
          <MixesInspiredBy class="pb-1.5" text="Dystopia" by="Megadeth" to="/artist"
    ...
    <div class="px-8 mt-8 min-w-[800px]">
      ...
      <div class="flex justify-start gap-7 ">
        ...
        <MultiArtistSelect class="w-1/4" category="daily"
          text="Featuring Metallica, Jessye Norman, Dresdner Philharmonie, San Francisco Symphony" to="/artist" :images="{
        ...
        <MultiArtistSelect class="w-1/4" category="daily" text="Featuring Panter, Alden Karik, Arturiko, Krista Masalta"
          to="/artist" :images="{
        ...
        <MultiArtistSelect class="w-1/4" category="daily"
          text="Featuring Machine Gun Kelly, Girlfriends, Mod Sun, Chri$tian Gate$" to="/artist" :images="{
    ...
    <div class="px-8 mt-8 min-w-[800px]">
      <div class="py-3"></div>
      <p class="text-center pb-6 text-[#D1D1D6] text-sm">Unlock Flow by selecting your favourite artists for improved
        recommendations.</p>
